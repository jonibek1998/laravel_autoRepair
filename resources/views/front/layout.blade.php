    ...
    <div class="grid place-items-center mx-2 my-20 sm:my-auto">
        ...
        <div>
            ...
            @if (Auth::check())
                ...
                <a class="bg-blue text-white font-bold py-2 px-4 border-b-4 hover:border-b-2 hover:border-t-2 border-blue-dark hover:border-blue rounded" href="/admin">Admin</a>
            @endif
            </div>
